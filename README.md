...
3. **SDNQ LoRA Stacker V2** (`SDNQLoraStackerV2_10`) - LoRA loader for SDNQ quantized models with dynamic 10-slot UI (compatible with [comfyui-sdnq-splited](https://github.com/ussoewwin/comfyui-sdnq-splited))
...
- v1.18 – SDNQ LoRA Stacker V2: Added SDNQ LoRA Stacker V2 node for SDNQ quantized models with dynamic 10-slot UI (compatible with [comfyui-sdnq-splited](https://github.com/ussoewwin/comfyui-sdnq-splited))
